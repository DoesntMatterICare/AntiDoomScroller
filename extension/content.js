...
(function () {
  ...
  // No-Porn scanner state
  let noPornEnabled = false;
  let flaggedImagesCount = 0;
  let pageBlockShown = false;
  let processedImages = new WeakSet();
  let pornScanObserver = null;
  let scanQueue = [];
  ...
  function showPageBlockOverlay() {
    ...
    overlay.innerHTML = `
      <div class="dg-porn-block-modal">
        <div class="dg-porn-block-icon">
          <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="1.5">
